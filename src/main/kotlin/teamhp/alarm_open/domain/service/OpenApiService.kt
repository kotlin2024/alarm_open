...
class OpenApiService(
    ...
    fun getAllRegionPerformanceList(): String {
        ...
        while(pageNo <=74){
            ...
            val url =
                "http://api.data.go.kr/openapi/tn_pubr_public_pblprfr_event_info_api?serviceKey=hsXmG%2FgEgrVuhQOtQYbh5PeLFEYnq5EH2PsY8%2BTuKGKbpU22A6sBWZ2SY1DQ3lNJrxKwF2GcpX0anmnwmNk6XQ%3D%3D&pageNo=$pageNo&numOfRows=100&type=xml"
